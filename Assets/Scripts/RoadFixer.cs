...
public class RoadFixer : MonoBehaviour
{
    ...
    public void FixRoadAtPosition(PlacementManager placementManager, Vector3Int temporaryPosition)
    {
        ...
        {
            if(CreateStaightRoad(placementManager, result, temporaryPosition)) {
                return;
            }
    ...
    private bool CreateStaightRoad(PlacementManager placementManager, CellType[] result, Vector3Int temporaryPosition)
    {
